    ...
    plugins: [
        laravel({
            input: ['resources/css/app.css',
                ...
                'resources/css/pages/admin-logs.css',
                'resources/css/pages/admin-logs-vps.css',
                ...
                'resources/css/pages/stock-category.css',
                'resources/css/pages/guide.css',
                'resources/css/pages/faq-page.css',
                ...
                'resources/js/pages/reset-password.js',
                'resources/js/pages/admin-logs-vps.js',
                'resources/js/pages/admin-crontab.js',
