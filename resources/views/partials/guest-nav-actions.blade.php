...
@php
    $isHome = request()->routeIs('home') || request()->is('home', 'user');
    ...
    <div class="user-nav-primary__inner">
        <div class="user-nav-primary__mid">
            <div class="user-nav-primary__cluster">
                <a href="{{ url('/home') }}" class="button-link user-nav-link user-nav-link--guest user-nav-link--guest-home @if($isHome) user-nav-link--active @endif">🏠 Trang chủ</a>
